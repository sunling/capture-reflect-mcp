...
- `title`, `keyword`, and `content`: a factual title, a meaningful filename keyword (up to 40 characters), and the Markdown review. Link inline citations relative to `reviews/YYYY/YYYYMM/`, using `../../../journals/...` or `../../../notes/...`. Cite consulted earlier reviews separately in the body, labeling them as prior interpretations.
