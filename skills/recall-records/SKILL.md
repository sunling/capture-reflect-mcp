...
Use `search_records` before answering from memory. Start with the user's most discriminating phrase or name and include a date range only when the request supplies or clearly implies one.
